...
const selectionSort = require("../sort-algos/selectionSort");
...
describe("Sorting", () => {
    ...
    // Selection Sort
    describe("Selection sort should", () => {
        test("properly sort an array of numbers from smallest to largest", () => {
            expect(selectionSort(input1)).toEqual(result1);
            expect(selectionSort(input2)).toEqual(result2);
        });
    });
